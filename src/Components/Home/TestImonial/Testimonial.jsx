                    ...
                    >
                        {
                            reviews.map(review => <SwiperSlide key={review._id}>
                                <div className="mx-14 text-center my-10 flex flex-col items-center justify-center gap-5">
                                    <Rating style={{ maxWidth: 250 }} value={review.rating} />
                                    <p><svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100" fill="none">
