                                            ...
                                            <div className="bg-base-200 shadow-xl">
                                                ...
                                                <div className="card-body items-center text-center">
                                                    ...
                                                    <div className="card-actions">
                                                        <button className="btn px-6 bg-gray-200 border-4 rounded-lg hover:bg-gray-800 hover:text-yellow-400 transition border-b-yellow-600 hover:border-b-yellow-600 hover:border-4">Buy Now</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
